...
<body style="background: -webkit-linear-gradient(45deg, rgba(213, 15, 61, 0.6), rgba(240, 229, 81, 0.69) 100%);">
  ...
  <div class="bg-dark">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow animated slideInRight">
  ...
  <div style="background-image: url('img/buildings.jpg'); height: 100%; background-attachment: fixed; background-repeat: no-repeat; background-position: center; background-size: cover">
    ...
    <div class="container">
      ...
      <div class="container">
        <div class="row">
        <div class="card-group bg-light mx-auto shadow-lg rounded">
            <div class="card-mb-3">
            ...
            <div class="card bg-light">
              ...
              <div class="card-body">
                ...
                <p class="card-text">We are building a platform so that tourists and
                    guides alike can meet, exchange, discover and have fun!</p>
              </div>
            </div>
          </div>
        </div>
