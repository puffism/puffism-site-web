...
<body style="background-color:rgb(114, 198, 236);">
  ...
  <div class="card mx-auto" style="max-width: 25rem; max-height: 50rem">
    ...
    <div class="card-body">
      ...
      <form class="px-4 py-3" action="traitement_join.php" method="post">
        ...
        <div class="input-group mb-3 col mx-auto">
          <input type="text" class="form-control" name="validate_password" placeholder="Re-enter password" aria-label="Re-enter password"
            aria-describedby="basic-addon1">
        </div>
        ...
        <div class="text-center">
            <button class="btn btn-outline-success"  type="submit" id="button-addon4"> Become a Puffin </button>
        </div>
        <?php
        if (isset($erreur)) {
          echo $erreur;
